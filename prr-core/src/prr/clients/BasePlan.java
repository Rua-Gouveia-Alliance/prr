...
public class BasePlan implements ClientPlan {
    public long calcTextPrice(Communication communication) {
        ...
        if (communication.getDuration() < 100) {
            if (communication.getClientType() == ClientTypeEnum.NORMAL) return 16;
            if (communication.getClientType() == ClientTypeEnum.GOLD) return 10;
            return 4;
        }
    ...
    public long calcVideoPrice(Communication communication) {
        if (communication.getClientType() == ClientTypeEnum.NORMAL) return 30;
        if (communication.getClientType() == ClientTypeEnum.GOLD) return 20;
        return 10;
    }
